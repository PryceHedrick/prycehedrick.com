...
export function AuditForm() {
  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent) => {
      ...
      fireEvent("audit_request_submit", { business_type: formData.businessType });
      try {
  ...
  if (submitted) {
    return (
      <div className="text-center py-24">
        <div className="h-16 w-16 rounded-full bg-[#0ea5e9]/20 flex items-center justify-center mx-auto mb-8">
      ...
      <div>
        ...
        <div className="space-y-6 mb-10">
          <div className="flex items-start gap-4">
            <div className="h-10 w-10 rounded-lg bg-[#0ea5e9]/10 flex items-center justify-center flex-shrink-0 mt-0.5 text-[#0ea5e9]">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {submitError && (
            <div className="rounded-xl bg-red-900/30 border border-red-700/50 px-4 py-3 text-sm text-red-300">
              There was a problem submitting your request. Please email{" "}
