...
export function Nav() {
  ...
  return (
    <header className="px-6 lg:px-8 h-20 flex items-center justify-between border-b border-[#1F2937] relative z-50">
      ...
      <div className="flex md:hidden items-center gap-4">
        <a href="tel:+18126109805" className="text-sm font-medium text-[#0D9488]">
          (812) 610-9805
        </a>
        <button
      ...
      {open && (
        <div className="absolute top-20 left-0 right-0 bg-black border-b border-[#1F2937] md:hidden">
